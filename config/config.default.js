...
module.exports = appInfo => {
  ...
  return {
    ...
    wechatRouter: {
      ...
      match: [ctx => ctx.path.startsWith('/manage/wechat')],

    },
    orderRouter: {

      match: [ctx => ctx.path.startsWith('/manage/order')],

    },

    shopRouter: {

      match: [ctx => ctx.path.startsWith('/manage/shop')],
  ...
  // testComponentPluginBegin



  // testComponentPluginEnd
