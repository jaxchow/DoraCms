...
exports.doraWechat = {
    ...
    enable: true,
    package: 'egg-dora-wechat',
    path: path.join(__dirname, "../lib/plugin/egg-dora-wechat")
};
...
exports.doraOrder = {
    ...
    enable: true,
    package: 'egg-dora-order',
    path: path.join(__dirname, "../lib/plugin/egg-dora-order")
};

exports.doraShop = {

    enable: true,
    package: 'egg-dora-shop',
    path: path.join(__dirname, "../lib/plugin/egg-dora-shop")
};
            // orderPluginEnd
